...
{
  SparseNode* array = malloc(sizeof(index));
  array->value = value;
  array->index = index;
  array->left = NULL;
  array->right = NULL;
...
SparseNode * SparseArray_insert ( SparseNode * array, int index, int value )
{
  ...
  if((array->value) > value)
    {
      array->left = SparseArray_insert(array->right, value);
    }
  array->right = SparseArray_insert(array->right, value);
  ...
  for(i = 0;i<length;i++)
    {
      if(value[i] !=0)
	{
	  fr = SparseArray_insert(fr,value[i],index[i]);
	}
    }
  return fr;
}
...
SparseNode * SparseArray_remove ( SparseNode * array, int index )
{
  ...
  if((array->index) == index)
    {
      SparseNode * list = array->next;
      free(array);
      return list;
    }
  array->next = SparseArray_remove(array->next,index);
  return array;
}
...
SparseNode * SparseArray_copy(SparseNode * array)
{
  ...
  list->next = SparseArray_copy(array->next)
  return list;
}
 ...
 */
SparseNode * merge_help_1(SparseNode * tr, SparseNode * p)
{
  if(p == NULL)
    {
      return tr;
    }
  tr = merge_help_1(tr,p->left);
  tr = merge_help_1(tr,p->right);
  tr = merge_help_2(tr,p->index,tr->value);
  return tr;
}
SparseNode * merge_help_2(SparseNode * array, int index, int value)
{
  if(array == NULL)
    {
      return SparseNode(create(index,value));
    }
  if(value == 0)
    {
      return array;
  ...
  if(array->index == index)
    {
      ...
      if((array->value)==0)
	{
	  array = Sparse_remove(array,array->index);
	}
      return array;
    }
  if(array->index > index)
    {
      array->left = merge_help_2(array->left,index,value);
    }
  if(array->index < index)
    {
      array->right = merge_help_2(array->right,index,value);
    }
  return array;
}
SparseNode * SparseArray_merge(SparseNode * array_1, SparseNode * array_2)
{
  Sparse * array_3 = SparseArray_copy(array_1);
  array_3 = merge_help_1(array_3,array_2);
  return NULL;
}
